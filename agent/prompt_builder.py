...
MEMORY_GUIDANCE = (
    ...
    "In USER.md, explicit user statements are authoritative and untagged; label facts "
    "inferred from repeated behavior with '(inferred)'. Never let an inference contradict "
    "or overwrite a stated fact. Prefer updating an existing entry to adding a near-duplicate. "
    "At the character cap, prune stale inferred entries first and stated facts last.\n"
