...
_MEMORY_REVIEW_PROMPT = (
    ...
    "Give explicit user statements roughly twice the weight of inferred patterns. Do not "
    "persist one-off behavior; repeated behavior may be saved in USER.md with '(inferred)'. "
    "Keep stated facts untagged, and never let an inference contradict or overwrite one. "
    "Prefer updating an existing entry over adding a near-duplicate; at the character cap, "
    "prune stale inferred entries first and stated facts last. Keep entries terse.\n\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "preferences with the memory tool. Give explicit statements roughly "
    "twice the weight of inferred patterns. Do not persist one-off behavior; "
    "repeated behavior may be saved in USER.md with '(inferred)'. Keep stated "
    "facts untagged, and never let an inference contradict or overwrite one. "
    "Prefer updating an existing entry over adding a near-duplicate; at the "
    "character cap, prune stale inferred entries first and stated facts last. "
    "Keep entries terse.\n\n"
